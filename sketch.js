...
boy.scale = (2);
 ...
 healthBar1.shapeColor = "white";
  ...
  healthBar2 = createSprite(windowWidth-230,100,300,25);
  healthBar2.shapeColor = "white";

  healthLevel2 = createSprite(windowWidth-230,100,290,15);
 ...
 bt = createSprite(70,windowHeight-160,50,50);
  ...
  restart.mousePressed(() => {
    gameState = "play";
    healthLevel1.x = 175;
    healthLevel2.x = windowWidth-240;
    boy.x = 400;
...
if(gameState==="serve"){
  ...
  text("Press space bar to start the game",200,200);
  gameState="play"
}
...
//boy punching 
 ...
 if(healthLevel1.x<-100) {
  ...
  if(healthLevel2.x>windowWidth+50) {
    gameState = "boyWin";
  }
 }
